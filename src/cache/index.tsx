...
export default class Cache<K, V> {
  ...
  reset() {
    ...
    this[Index] = new Map<K, V>(); // hash of items by key
  ...
  set(key: K, value: V, maxAge?: number) {
    ...
    this[Index].set(key, this[LIST].head);
    trim(this);
    return true;
  }
  ...
  has(key: K): boolean {
    ...
    const hit = this[Index].get(key).value;
  ...
  prune() {
    this[Index].forEach((_value, key) => get(this, key, false));
  }
}
